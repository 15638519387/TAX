...
<body>
			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td align="center"></td>
                        <td align="left"></td>
                        <td align="left"><a><b></b><font color="red">欢迎您,${user_map.name}</font></a></td>
						...
						<td align="left" valign="middle"><a href="${pageContext.request.contextPath }/tui" target="_top">退出</a></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
				<li><a href="../home/home.jsp" target="_top">工作主页</a></li>
