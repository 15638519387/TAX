...
public interface RoleDao {
	 ...
	 * @return
	 */
	public int role_pdel(@Param(value="id")Integer id);
	 ...
	 * @return
	 */
	public int role_pdels(@Param(value="list")List<Integer> list);
	 ...
	 * @return
	 */
	public int dels(@Param(value="list")List<Integer> list);
}
